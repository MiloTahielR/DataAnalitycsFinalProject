...
•Dashboards interactivos en Power BI con enfoque en UX (botones de navegación y múltiples vistas analíticas).  
•Análisis exploratorio para la validación de hipótesis de negocio, cruzando variables demográficas con el comportamiento transaccional.
•Presentación de insights accionables, identificando que el mayor volumen de ventas provino del segmento joven, y proponiendo estrategias de fidelización y reactivación.
